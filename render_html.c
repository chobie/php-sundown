...
PHP_METHOD(sundown_render_html, blockCode)
{
	...
	hoedown_buffer *input, *lang, *output;
...
PHP_METHOD(sundown_render_html, table)
{
	...
	hoedown_buffer *b_header, *b_body, *output;
	php_sundown_render_html_t *html;
	php_sundown_render_base_t *base;
...
PHP_METHOD(sundown_render_html, image)
{
	...
	hoedown_buffer *b_link, *b_title, *b_alt_text, *output;
	php_sundown_render_html_t *html;
	php_sundown_render_base_t *base;
...
PHP_METHOD(sundown_render_html, link)
{
	...
	hoedown_buffer *m_link, *m_title, *m_content, *output;
	php_sundown_render_html_t *html;
...
void php_sundown_render_html_init(TSRMLS_D)
{
	...
	zend_declare_property_null(sundown_render_html_class_entry, ZEND_STRS("render_flags")-1, ZEND_ACC_PUBLIC TSRMLS_CC);
}
